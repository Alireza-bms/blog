            ...
            <ul class="nav flex-column pe-3">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/blog/admin-panel-template/pages/posts/index.php">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/blog/admin-panel-template/pages/categories/index.php">
                ...
                <li class="nav-item">
                    <a class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                        href="/blog/admin-panel-template/pages/comments/index.php">
